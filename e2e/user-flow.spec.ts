...
test.describe.skip('Complete User Journey', () => {
  test('should complete full user workflow from signup to card management', async ({ page }) => {
    ...
    await test.step('Edit a card', async () => {
      ...
      const editButton = cardToEdit
        .locator('button[aria-label*="Edit"]')
        .or(cardToEdit.locator('button').filter({ hasText: /edit/i }));
    ...
    await test.step('Delete a card', async () => {
      ...
      const deleteButton = cardToDelete
        ...
        .or(cardToDelete.locator('button').filter({ hasText: /delete|remove/i }));
    ...
    await test.step('Sign out', async () => {
      ...
      const userButton = page
        .locator('button[data-testid="user-button"]')
        .or(page.locator('[class*="cl-userButton"]'));
