...
test.describe.skip('Card CRUD Operations', () => {
  ...
  test('should create a new card', async ({ page }) => {
    ...
    const addButton = todoColumn
      .locator('button')
      .filter({ hasText: '+' })
      .or(todoColumn.locator('button[aria-label*="Add"]'));
  ...
  test('should edit an existing card', async ({ page }) => {
    ...
    const cards = page
      ...
      .or(page.locator('.card').or(page.locator('[class*="card"]')));
    ...
    const editButton = firstCard
      ...
      .or(firstCard.locator('button').filter({ hasText: 'Edit' }));
  ...
  test('should delete a card', async ({ page }) => {
    ...
    const deleteButton = cardToDelete
      .locator('button[aria-label*="Delete"]')
      .or(cardToDelete.locator('button').filter({ hasText: 'Delete' }));
  ...
  test('should support adding notes to a card', async ({ page }) => {
    ...
    const notesField = page
      ...
      .or(page.locator('input[name="notes"]'));
