...
test.describe.skip('Organization Switching', () => {
  ...
  test('should display organization switcher', async ({ page }) => {
    ...
    const orgSwitcher = page
      ...
      .or(page.locator('[class*="organization"]').filter({ hasText: /organization/i }));
  ...
  test('should show current organization name', async ({ page }) => {
    ...
    const orgSwitcher = page
      .getByTestId('organization-switcher')
      .or(page.locator('[class*="cl-organizationSwitcher"]'));
  ...
  test('should open organization menu when clicked', async ({ page }) => {
    ...
    const menu = page.locator('[role="menu"]').or(page.locator('[class*="organizationList"]'));
  ...
  test('should list available organizations', async ({ page }) => {
    ...
    const orgItems = page
      ...
      .or(page.locator('[class*="organizationPreview"]'));
